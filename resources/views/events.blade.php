...
<html lang="en">
  ...
  <body id="hero-about">
    ...
    <section class="">
        <h1 class="text-center text-4xl py-4 my-4">EVENTS</h1>

        <form action="/events" >
            <div class="max-w-screen-2xl relative mx-auto border-2 border-gray-100 m-4 rounded-lg">
